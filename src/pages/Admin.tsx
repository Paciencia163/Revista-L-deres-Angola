...
import { 
  ...
  MessageSquare, LogOut, Plus, Pencil, Trash2, Eye, EyeOff, Image, Users
} from "lucide-react";
import { useToast } from "@/hooks/use-toast";

type Tab = "articles" | "categories" | "editions" | "comments" | "banners" | "subscribers";
...
const Admin = () => {
  ...
  const fetchAll = async () => {
    const [artRes, catRes, edRes, comRes, banRes, subRes] = await Promise.all([
